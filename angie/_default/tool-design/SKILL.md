---
name: tool-design
description: Design effective tools for AI agents - tool descriptions, consolidation principles, architectural reduction, MCP naming conventions, and error handling
agents: [rex, grizz, nova, blaze, bolt, cleo, morgan]
triggers: [tool, mcp, api design, tool description]
---
...
**Source**: [Agent-Skills-for-Context-Engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering)
**Original Author**: Agent Skills for Context Engineering Contributors
**Adapted for**: CTO Platform
**Version**: 1.1.0
