...
description: Dispatch one agent per independent problem domain for concurrent investigation and implementation.
---
...
Can they work in parallel?
    ↓ yes                    → no (shared state): Sequential agents
Parallel dispatch!
```
...
Based on [obra/superpowers](https://github.com/obra/superpowers) dispatching-parallel-agents skill.
